...
WHY THIS EXISTS: the entity app's memory view renders the frozen
...
Usage:
    .venv/bin/python abstractentity/scripts/export_demo_entity.py \
        [--out abstractentity/public/demo/castor.ndjson]
