 ...
 * asking me again!").
 *
 * When the entity app is served by its own CLI (bin/cli.js), the
 ...
 * the server-side gateway session out). Since the 2026-07-12 split this
 * app is its OWN origin with its own appId-namespaced cookies
 * (abstractentity_gateway_*) — signing out here affects only this app;
